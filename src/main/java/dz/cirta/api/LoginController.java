...
/**
 * front controller used for authenticating users coming only from <a href="https://rahba.net">rahba.net</a>.
 ...
 * valid user is everyone who uses <a href="https://rahba.net">rahba.net application</a> and seeking secured urls such as: /search or /book <br>
...
public class LoginController {
   ...
   /**
    * domain name of <a href="https://rahba.net">rahba.net</a>
    */
   @Value("${rahba.net.dns}")
